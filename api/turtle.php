<?php
	...
	function fillItem($row)
	{
		...
		$item['acquired_latitude'] = dbFloatOrNull($row['acquired_latitude'], 5);
		$item['acquired_longitude'] = dbFloatOrNull($row['acquired_longitude'], 5);
		...
		$item['relinquished_latitude'] = dbFloatOrNull($row['relinquished_latitude'], 5);
		$item['relinquished_longitude'] = dbFloatOrNull($row['relinquished_longitude'], 5);
	...
	else if (($verb == 'PUT') || ($verb == 'POST'))
	{
		...
		$stmt->bindValue(':acquired_latitude', dbGetParameterFloat($parameters, 'acquired_latitude', 5));
		$stmt->bindValue(':acquired_longitude', dbGetParameterFloat($parameters, 'acquired_longitude', 5));
		...
		$stmt->bindValue(':relinquished_latitude', dbGetParameterFloat($parameters, 'relinquished_latitude', 5));
		$stmt->bindValue(':relinquished_longitude', dbGetParameterFloat($parameters, 'relinquished_longitude', 5));
