<?php
	...
	else if (($verb == 'PUT') || ($verb == 'POST'))
	{
		...
		if ($verb == 'PUT')
		{
			...
			$washbacks_doa_event_id = $parameters['washbacks_doa_event_id'];
		}
		else if ($verb == 'POST')
		{
			...
			$washbacks_doa_event_id = utilCreateGuid();
		}
		$stmt = $db->prepare($sql);
		
		$stmt->bindValue(':washbacks_doa_event_id', $washbacks_doa_event_id);
