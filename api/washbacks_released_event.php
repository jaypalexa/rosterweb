<?php
	...
	else if (($verb == 'PUT') || ($verb == 'POST'))
	{
		...
		if ($verb == 'PUT')
		{
			...
			$washbacks_released_event_id = $parameters['washbacks_released_event_id'];
		}
		else if ($verb == 'POST')
		{
			...
			$washbacks_released_event_id = utilCreateGuid();
		}
		$stmt = $db->prepare($sql);
		
		$stmt->bindValue(':washbacks_released_event_id', $washbacks_released_event_id);
